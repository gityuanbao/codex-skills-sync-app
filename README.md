...
第一次使用可以先观看：[Codex 技能同步器 Mac 安装与使用教程（MP4，约 7.7 MB）](https://github.com/gityuanbao/codex-skills-sync-app/releases/download/v0.3.4/Codex-Skills-Sync-Mac-Guide-v0.3.4.mp4)。
