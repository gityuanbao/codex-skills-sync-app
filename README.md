...
| 系统 | 支持版本 | 下载 |
| --- | --- | --- |
| macOS | Apple Silicon（M1/M2/M3/M4） | [下载 Mac 版 DMG](https://github.com/gityuanbao/codex-skills-sync-app/releases/download/v0.3.4/Codex-Skill-Sync-0.3.4-mac-arm64.dmg) |
| Windows | Windows 10/11 x64 | [下载 Windows 版](https://github.com/gityuanbao/codex-skills-sync-app/releases/download/v0.3.4/Codex-Skill-Sync-0.3.4-win-x64.exe) |
...
1. 下载并打开 `.dmg` 文件。
2. 把“Codex 技能同步器”拖到“Applications（应用程序）”。
3. 从“应用程序”文件夹打开软件。
